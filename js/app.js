...
/* ============================================================
   API
   ============================================================ */
// Token de seguretat: ha de coincidir amb APP_TOKEN del Code.gs.
// Aquest fitxer és al codi públic de GitHub, però el token per si sol no
// dona accés a res sense la URL /exec correcta (que va al localStorage).
// Tot i així, per màxima seguretat pots deixar-lo buit aquí i posar-lo a
// la configuració del dispositiu. Per simplicitat d'instal·lació, el posem
// aquí perquè no s'hagi d'entrar a cada mestre.
const APP_TOKEN = 'PoldelPozoMurgou1899@';
