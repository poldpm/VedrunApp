...
function showPage(pageId) {
  ...
  if (pageId === 'assoliments')  { if (typeof _perfilRenderAssimSelector === 'function') _perfilRenderAssimSelector(); renderAssoliments(); }
...
function selectAssimMateria(mat, btn) {
  ...
  renderAssoliments();
  // Carrega els alumnes del grup d'aquesta assignatura (si en té) en segon pla
  _assimLoadGrupStudents(mat);
}
